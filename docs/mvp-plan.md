...
- **Physician feedback received** (voice memo + reference videos, transcripts in `context/transcripts/`): assessed and specified in `docs/breath-animation-plan.md` — a model-driven teaching "Guide" view of the coordinated breath (muscle activation states, pelvic floor, whole-figure oscillation), with two selectable scripts, Quiet breath and Supported breath (her decision, 2026-08-15). Handoff-ready; not yet implemented.
